...
\begin{titlepage}
	\begin{center}
		\vspace*{1.5 cm}
		\textbf{Application of Mathematical Methods in the Study of Chemical Dynamical Systems to an Inventory Multiplier-Acclerator Model}
...
\chapter{Computational Analysis of the Metlerian Inventory Cycle Model with Averaged Expectations, Endogenous Investment, and Consumption Lag}
