...
In this business cycle model, the economy is closed and income is determined completely by the quantity of goods produced by firms. Goods are completely homogenized but can be produced for 3 purposes: stock $S$, predicted consumption $U$, and investment $I$. This lets us define income $Y$ as the sum of these 3 factors:
\begin{equation}
    Y_t=I_t+S_t+U_t
\end{equation}
...
\begin{equation}\label{eq:metzlerian_simple-savings}
    S_t=\hat Q_t-Q_{t-1}
\end{equation}
...
\begin{equation}\label{eq:metzlerian_simple-predicted_consumption}
...
\begin{equation}\label{eq:metzlerian_simple-condensed_income}
